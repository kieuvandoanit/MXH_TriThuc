...
INSERT INTO `comment` (`Comment_id`, `Content`, `CreateDate`, `UpdateDate`, `Status`, `isDelete`, `Member_id`, `Post_id`) VALUES
(1, 'Comment ', '2021-07-08 16:09:58', '2021-07-08 16:09:58', 'yes', 0, 1, 1);
...
CREATE TABLE `post` (
  ...
  `Content` text COLLATE utf8_unicode_ci NOT NULL,
  `Status` enum('Chờ duyệt','Đã duyệt','Duyệt tự động','Không được duyệt') COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `voting` (
  ...
  `Member_id` int(11) DEFAULT NULL,
  `Rate` enum('1 sao','2 sao','3 sao','4 sao','5 sao') COLLATE utf8_unicode_ci DEFAULT NULL,
  `time` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
