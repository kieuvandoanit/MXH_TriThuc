...
<br>
<form enctype="multipart/form-data" action="<?php echo HEADERLINK.'/admin/user/handleCreateUser';?>" method="POST" style="margin: 0 100px 0 15px;">
    <div class="row">
        <div class= "col-3">
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <input type="hidden" value="/uploads/avatar.jpg" id="avatar" name="avatar" class="form-control">
